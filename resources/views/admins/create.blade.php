        ...
        <div class="card-body">
            <form action="/saveadmin" class="row" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="nama_admin" id="nama_admin" placeholder="Masukan Nama Anda">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" name="alamat_admin" id="alamat admin"></textarea>
                    <div class="mt2 text-denger">
                        @error('alamat_admin')
                            {{ $message }}
                        @enderror
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" class="form-control" name="email_admin" id="email" placeholder="Isi Email Anda">
                    <div class="mt2 text-denger">
                    @error('email_admin')
                        {{ $message }}
                    @enderror
                ...
                <div class="col-md-6">
                    ...
                    <input type="pssword" class="form-control" name="password_admin" id="password" placeholder="Isi Pasword ">
                    <div class="mt2 text-denger">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="jabatan_admin" id="masuk" placeholder="Masukan Jabatan">
                    <div class="mt2 text-denger">
                    @error('jabatan_admin')
                        {{ $message }}
                    @enderror
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="nohp_admin" id="nohp_admin" placeholder ="Masuk No Hp Anda">
                    <div class="mt2 text-denger">
                    @error('nohp_admin')
                        {{ $message }}
                    @enderror
